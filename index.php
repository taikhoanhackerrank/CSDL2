    ...
    <div class="col modal_zapatilla_eliminada">
        <div class="row">
            <div class="col elmodal_zapatilla_eliminada">
                <div class="row">
                    <div class="col jus">
                        <p class="zapa_eliminada">Shoe removed correctly</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col modal_usuario_incorrecto">
        <div class="row">
            <div class="col elmodal_usuario_incorrecto">
                <div class="row">
                    <div class="col">
                        <p class="usuario_incorrecto">Username or password do not match</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col modal_registro_incorrecto">
        <div class="row">
            <div class="col elmodal_registro_incorrecto">
                <div class="row">
                    <p class="col registro_incorrecto">The user already exists or entered the data incorrectly</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col modal_registro_succes">
        <div class="row">
            <div class="col elmodal_registro_succes">
                <div class="row">
                    <div class="col">
                        <p class="registro_succes">The user has been created successfully</p>
                    </div>
                </div>
            </div>
        </div>
      ...
      <div class="col modal_compra">
        <div class="row">
          <div class="col elmodal_compra">
            <div class="row">
              <div class="col jus">
                <p class="zapa_eliminada">Successful purchase</p>
              </div>
            </div>
          </div>
        </div>
...
<div class="col modal-container1" id="modal_container1">
    ...
    <div class="row modal1">
        <div class=" col">
            ...
            <div class="row">
                <div class="col">
                    <h1 class="formulario_login1">Check in</h1>
                </div>
            </div>
            ...
            <?php
             if(empty ($_POST['user']) || empty ($_POST['email']) || empty ($_POST['ciudad']) || empty ($_POST['calle']) || empty ($_POST['password'])){ 
                ...
                echo '  
                    ...
                    <div class="col">
                        <input class="input_text" type="text" name="user" placeholder="username"/>
                    </div>
                    </div>
                    <div class="row pb-3">
                    <div class="col">
                    ...
                    <div class="col">
                        <input class="input_text" type="email" name="email" placeholder="login@gmail.com"/>
                    </div>
                    </div>
                    <div class="row pb-3">
                    <div class="col">
                    ...
                    <div class="col">
                        <input class="input_text" type="text" name="ciudad" placeholder=":>>"/>
                    </div>
                    </div>
                    <div class="row pb-3">
                    <div class="col">
                    ...
                    <div class="col">
                        <input class="input_text" type="text" name="calle" placeholder="Street"/>
                    </div>
                    </div>
                    <div class="row pb-3">
                    <div class="col">
...
<div class="col modal_container2" id="modal_container2">
    <div class="row modal2">
        <div class=" col">
            ...
            <div class="row">
                <div class="col">
                    <h1 class="formulario_login2">Log in</h1>
                </div>
            </div>
                    ...
                    <?php
                        ...
                        echo '
                            ...
                            <div class="row pb-3 ">
                                ...
                                <div class="col">
                                    <input class="input_text" type="text" name="usuario" placeholder="username"/>
                                </div>
                            </div>
                            <div class="row pb-3">
                            <div class="col">
                            ...
                            <div class="col">
                                <input class="input_text" type="password"  name="contraseña" placeholder="Password"/>
                            </div>
                            </div>  
                            </div>
                            </div>
                            <div class="row">
                            <div class="col d-flex justify-content-center">
                                <input class="btn_inicio_sesion"  id="close2" type="submit" value="Log in" />
                            </div>
                            </div>
                            </form>
                        ';
        ...
        <div class="col modal_carrito">
          <div class="row">
            <div class="col elmodal_carrito">
              ...
              <div class="row">
                <div class="col">
                  <div class="titulo_carrito">Your cart</div>
                </div>
              </div>
            ...
            <div class="row margen d-flex align-items-end justify-content-start">
                <div class="col-6">
                    <p class="titulo_precio_carrito" >Total price: </p>
                </div>
                <div class="col-4">
                ...
                <div class="col ">
                    ...
                    echo'
                        <form action ="index.php" method = "POST">
                            ...
                            <button class="btn_carrito_comprar"  type="submit" name="carrito_comprar">Buy</button>
                        </form>
                    ';
                        // COMPRA FINAL
        ...
        <div class="col modal_perfil">
          <div class="row">
            <div class="col elmodal_perfil">
              ...
              <div class="row">
                <div class="col">
                  <div class="titulo_perfil">Your profile</div>
                </div>
              </div>
            <div class="row ">
              <div class="col ">
                <button class="btn_perfil_datos" onclick=" perfil()">Personal information</button>
              </div>
            </div>
            <div class="row ">
              <div class="col ">
                <button class="btn_perfil_pedidos" onclick="pedidos()">Orders</button>
              </div>
            ...
            <div class="row ">
              <div class="col ">
                <form action ="index.php" method = "POST">
                    <button class="btn_perfil_cerrar_sesion" type="submit" name="btn_cerrar_sesion" value="btn_cerrar_sesion">Sign off</button>
                </form>
              </div>
...
<div class="container-fluid ">
    ...
    <div class="row  header">
        <div class="col-lg-8 col-md-4 col- 12 text-left titulo ">HM-Sneakers</div>
        <div class="col-lg-4 col-md-8 col-12">
            ...
            if(!isset( $_SESSION["nombre_usuario"])){
                echo '  
                    <div class="row">
                        <div class="col-6"><button class="btn-header" id="open2">Log in</button></div>
                        <div class="col-6"><button class="btn-header" id="open1"> Check in</button></div>    
                    </div>
                ';
            }else{
                echo'
            ...
            if(!isset($_REQUEST['filtros'])){
                echo'
                    <div class="row  w-100 m-5 justify-content-center fila_filtros">
                        <div class="col-lg-3 col-6">Filter brand: </div>
                        ...
                        <form action ="index.php" method = "POST">
                            ...
                            <div class="col-lg-3 col-6">
                                <button class="btn_filtros" type="submit" name="filtros" value="filtros">Filter</button>
                            </div>
                            <div class="col-lg-3 col-6">
                                <button class="btn_filtros" type="submit" name="delete_filtros" value="delete_filtros">Remove filters</button>
                            </div>
                        </form>
                    </div>
            ...
            <div class="col">
                <div class="row">
                    <div class="col-12 col-lg-4 col-md-4 order-lg-1 order-md-1 order-2 avisos">
                        <p class="avisosp">. Legal warning</p>
                        <p class="avisosp">. Privacy Policy</p>
                        <p class="avisosp">. Cookies policy</p>
                    </div>
                ...
                <div class="row">
                    <div class="col d-flex justify-content-center copyright">©Copyright 2023 Hoa Mai</div>
                </div> 
            </div>   
        </div>    
    </div>
