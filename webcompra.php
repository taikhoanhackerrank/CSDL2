    ...
    <div class="col modal_comentario_succes">
        <div class="row">
            <div class="col elmodal_comentario_succes">
                <div class="row">
                    <p class="col comentario_success">Comment added successfully</p>
                </div>
            </div>
        </div>
    </div>
            ...
            echo '
                <div class="row mt-5  mb-5 m-0 p-0">
                    <div class="col d-flex justify-content-end">
                        <form action ="index.php" method = "POST">
                            <button class="btn_home" type="submit" name="home" value="home">Return to HOME</button>
                        </form>
                    </div>
                </div>
             ';
            ...
            <div class="row  m-0 p-0 pt-1 compra_top">   
                ...
                <div class="row px-5 pt-5 d-flex justify-content-around">
                    <div class="col-6 font_select">
                        <p class="opciones_compra">Size: </p>
                    </div>
                    <div class="col-6 font_select" >
                            <form action="webcompra.php" method="post">
                ...
                <div class="row px-5 pt-5 d-flex justify-content-around">
                    ...
                    <div class="col-6 font_select">
                        <select class="select_color " name="color">
                            <option class="option_color" value="blanco">White</option>
                            <option class="option_color" value="negro_verde">Black/Green</option>
                            <option class="option_color" value="rojo_azul">Red Blue</option>
                            <option class="option_color" value="negro_amarillo">Black/Yellow</option>
                        </select>
                    </div>
                </div>
                <div class="row px-5 pt-5 d-flex justify-content-around">
                    <div class="col-6">
                        <p class="opciones_compra_precio">Price:</p>
                    </div>
                ...
                <div class="row p-5">
                    <div class="col d-flex justify-content-center">
                            ...
                            <input class="btn_compra_zapatillas1" type="submit" value="Add to cart" />
                        </form>
                    </div>
                </div>
            </div>
...
// COMENTARIOS
                ...
                <div class="col-12 limit_EscribirComentario">
                    ...
                    <div class="row">
                        <div class="col div_btn_comentairos">
                            ...
                            <input class="btn_comentairos"  type="submit" value="Save comment" />
                        </div>
                            </form>
                    </div>
                </div>
        ...
        <div class="row mt-5 m-0 p-0">
            <div class="col ">
                <h3 class="limit_VerComentario ">Comments:</h3>
                <?php  
                $zapatillas =  $_REQUEST["zapatillas"];  
                $conexion = mysqli_connect('localhost', 'root', '', 'jr-sneakers');
